...
std::shared_ptr<Pose> Visual::getPose() const { return origin; }
...
bool Visual::empty() const { return false; }

const char* Visual::getTypename() { return "visual"; }
...
std::shared_ptr<GeometryBase> Visual::getGeometry() const { return geometry; }
