...
bool Mesh::isA(const char* name) const { return std::string(name) == "mesh"; }
...
void Mesh::setColor(Color c) { color = c; }
...
bool Mesh::empty() const { return false; }

const char* Mesh::getTypename() const { return "mesh"; }
