...
Sphere::Sphere() { this->radius = 1.0; }

Sphere::Sphere(double r) { this->setRadius(r); }
...
void Sphere::clear() { this->radius = 0.0; }
...
void Sphere::setRadius(double r) {
  if (r <= 0) {
    LOG_F(ERROR, "Attempt to set sphere radius to a non-positive value: %f", r);
    return;
  }
  radius = r;
}
...
bool Sphere::empty() const { return false; }
