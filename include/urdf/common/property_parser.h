#ifndef INCLUDE_URDF_COMMON_PROPERTY_PARSER_H_
#define INCLUDE_URDF_COMMON_PROPERTY_PARSER_H_
 ...
 * (which can be std::string, const char*, or double—only these types are
 * acceptable).
 * @code{.xml}
 *  <density value="1.0" />
 *  ...
...
#endif  // INCLUDE_URDF_COMMON_PROPERTY_PARSER_H_