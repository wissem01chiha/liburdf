#ifndef INCLUDE_URDF_INTERNAL_GEOMETRY_PARSER_H_
#define INCLUDE_URDF_INTERNAL_GEOMETRY_PARSER_H_
 ...
 * abstract object. It checks the geometry type and makes the pointer point to a
 * valid geometry structure (e.g., box, sphere, mesh, ...).
 * @code{.xml}
 *  <geometry>
...
#endif  // INCLUDE_URDF_INTERNAL_GEOMETRY_PARSER_H_
