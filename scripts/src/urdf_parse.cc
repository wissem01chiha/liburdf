 ...
 *          This tool uses the liburdf library to parse a given urdf file and optionally
 *          log its string representation if the `--log` flag is set.
 *          in case of failure, a summery error message is printed, no logging file is generated! 
 * @usage:
