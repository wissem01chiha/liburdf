...
// Use a different name based on whether the parameter is used as input or
// output
template <size_t N1, size_t N2>
constexpr descr<N1 + N2 + 1> io_name(char const (&text1)[N1],
                                     char const (&text2)[N2]) {
...
constexpr enable_if_t<B, descr<N1 + N2 + 1>> io_name(char const (&text1)[N1],
                                                     char const (&text2)[N2],
                                                     char const (&)[N3],
                                                     char const (&)[N4]) {
...
template <bool B, size_t N1, size_t N2, size_t N3, size_t N4>
constexpr enable_if_t<!B, descr<N3 + N4 + 1>> io_name(char const (&)[N1],
                                                      char const (&)[N2],
                                                      char const (&text3)[N3],
                                                      char const (&text4)[N4]) {
...
template <size_t N1, size_t N2, typename... Ts1, typename... Ts2>
constexpr descr<N1 + N2 + 3, Ts1..., Ts2...> operator|(
...
template <size_t N1, size_t N2, typename... Ts1, typename... Ts2>
constexpr descr<N1 + N2 + 2, Ts1..., Ts2...> operator,(
    const descr<N1, Ts1...> &a, const descr<N2, Ts2...> &b) {
  return a + const_name(", ") + b;
}
