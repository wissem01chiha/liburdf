...
PYBIND11_WARNING_DISABLE_MSVC(
    5054)  // https://github.com/pybind/pybind11/pull/3741
...
struct EigenProps {
  ...
  static constexpr auto descriptor =
      ...
      npy_format_descriptor<Scalar>::name + io_name("", "]") +
      const_name(", \"[") +
      ...
      // 'typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3,2]"]' and an
      // error message that you *gave* a numpy.ndarray of the right type and
      // dimensions.
...
struct type_caster<Type, enable_if_t<is_eigen_sparse<Type>::value>> {
  ...
  static handle cast(const Type &src, return_value_policy /* policy */,
    ...
    object matrix_type = module_::import("scipy.sparse")
    ...
    return matrix_type(
               pybind11::make_tuple(std::move(data), std::move(innerIndices),
