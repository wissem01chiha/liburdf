...
class duration_caster {
 public:
  ...
  static const std::chrono::duration<rep, period> &get_duration(
      const std::chrono::duration<rep, period> &&) = delete;
...
inline std::tm *localtime_thread_safe(const std::time_t *time, std::tm *buf) {
    ...
    defined(_MSC_VER)
  if (localtime_s(buf, time)) return nullptr;
  return buf;
#else
...
class type_caster<
 ...
 public:
  ...
  static handle cast(
    ...
    // Get out microseconds, and make sure they are positive, to avoid bug in
    // eastern hemisphere time zones (cfr.
