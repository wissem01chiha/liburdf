 ...
 public:
  ...
  explicit pythonbuf(const object &pyostream, size_t buffer_size = 1024)
      : buf_size(buffer_size <
                         minimum_buffer_size  // ternary avoids C++14 std::max
                                              // ODR-use of static constexpr
                     ? minimum_buffer_size
                     : buffer_size),
...
/** \rst
 ...
 \endrst */
inline class_<detail::OstreamRedirect> add_ostream_redirect(
    module_ m, const std::string &name = "ostream_redirect") {
