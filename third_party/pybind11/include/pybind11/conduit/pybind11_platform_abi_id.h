...
// Implementation details. DO NOT USE ELSEWHERE. (Unfortunately we cannot #undef
// them.) This is duplicated here to maximize portability.
#define PYBIND11_PLATFORM_ABI_ID_STRINGIFY(x) #x
#define PYBIND11_PLATFORM_ABI_ID_TOSTRING(x) \
  PYBIND11_PLATFORM_ABI_ID_STRINGIFY(x)
...
#define PYBIND11_COMPILER_TYPE \
  "system"  // Assumed compatible with system compiler.
#else
#error "Unknown PYBIND11_COMPILER_TYPE: PLEASE REVISE THIS CODE."
#endif
#endif

// PR #5439 made this macro obsolete. However, there are many manipulations of
// this macro in the wild. Therefore, to maintain backward compatibility, it is
// kept around.
...
#define PYBIND11_BUILD_ABI \
  "_mt_mscver" PYBIND11_PLATFORM_ABI_ID_TOSTRING(_MSC_VER)
#else
#if (_MSC_VER) / 100 == 19
...
//           // THIS ASSUMPTION IS NOT FUTURE PROOF but apparently the best we
//           can do.
//           // Please let us know if there is a way to validate the assumption
//           here.
